...
def game_play():
    ...
    while rounds < 3:           # loop 3 rounds
        ...
        while not game_over:      # start first deal looop
            ...
            player_input = input("Would you like to 'hit' or 'stay'? ").lower()         # players move
            if player_input == 'hit':
                player_cards.append(card_deal(player_cards))
...
#pause for dramatic effect?
    ...
    if game_play_again == "yes":
        game_play()            # restart 3 rounds after promt
    else:
        game_over = True
game_play()   #start teh game
